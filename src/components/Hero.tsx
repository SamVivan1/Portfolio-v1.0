...
export default function Hero() {
  return (
    <section
      id="hero"
      className="flex flex-col md:flex-row items-center justify-center min-h-screen px-4 md:px-10 gap-8 md:gap-12 pt-16 sm:pt-20 md:pt-0"
    >
      ...
      <div className="flex flex-col items-start max-w-xl w-full md:w-auto order-2 md:order-1 mb-8 md:mb-0">
        ...
        {/* Spotify Player - positioned below Download CV button */}
